...
{
    internal sealed class SyntyGenericParticlesLitShaderProfile : ShaderProfile
    {
        private static readonly string[] Names = { "Synty/Generic_ParticlesLit" };
        public override string Name => "SyntyGenericParticlesLit";
        public override string DiagnosticId => "synty.genericParticlesLit";
        ...
        public override ShaderProfileConversionKind ConversionKind => ShaderProfileConversionKind.SyntyParticleLit;
        ...
        public override void DiagnoseMaterialFeatures(Material material, bool litMaterial, ConversionDiagnostics diagnostics)
        {
            ...
            if (material.IsKeywordEnabled("_RECEIVE_SHADOWS_OFF"))
            {
                diagnostics.mapped.Add("material.receiveShadows.disabled");
                diagnostics.warnings.Add("Synty Generic_ParticlesLit declares receive shadows disabled in its URP ShaderGraph target. The converted particle object keeps receiveShadow disabled; this keyword is a mapped profile state.");
            }
        }
    }
}
